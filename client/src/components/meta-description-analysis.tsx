    ...
    <Card>
      <CardContent className="p-4 sm:p-6">
        <div className="flex items-center space-x-2 mb-4">
          ...
          <h3 className="text-base sm:text-lg font-semibold text-slate-900">Meta Description</h3>
        </div>
        ...
        <div className="border border-slate-200 rounded-lg p-3 sm:p-4">
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-2 gap-2">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-medium text-slate-900 text-sm sm:text-base">Description</span>
            </div>
          ...
          {data.description ? (
            ...
            <p className="text-xs sm:text-sm text-slate-500 italic">No meta description found</p>
          )}
        </div>
      </CardContent>
    </Card>
