          ...
          <div className="border border-slate-200 rounded-lg p-3 sm:p-4">
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-2 gap-2">
              <div className="flex items-center space-x-2">
                ...
                <span className="font-medium text-slate-900 text-sm sm:text-base">Open Graph Tags</span>
              </div>
              {getStatusBadge(getOpenGraphStatus())}
            </div>
            
            {data.openGraphTags ? (
              <div className="bg-slate-50 p-2 sm:p-3 rounded text-xs sm:text-sm overflow-x-auto">
                <div className="font-mono text-slate-600 space-y-1 break-all">
          ...
          <div className="border border-slate-200 rounded-lg p-3 sm:p-4">
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-2 gap-2">
              <div className="flex items-center space-x-2">
                ...
                <span className="font-medium text-slate-900 text-sm sm:text-base">Twitter Cards</span>
              </div>
