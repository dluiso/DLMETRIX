...
export default function Previews({ data }: PreviewsProps) {
      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex items-center space-x-2 mb-4">
            ...
            <h3 className="text-lg font-semibold text-slate-900">Google Preview</h3>
          </div>
          
          <div className="bg-slate-50 p-4 rounded-lg">
            <div className="text-sm text-slate-600 mb-1">{getGoogleUrl()}</div>
      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex items-center space-x-2 mb-4">
            ...
            <h3 className="text-lg font-semibold text-slate-900">Facebook Preview</h3>
          </div>
          
          <div className="bg-slate-50 p-4 rounded-lg">
            <div className="border border-slate-200 rounded-lg overflow-hidden bg-white">
              <div className="h-40 bg-slate-100 flex items-center justify-center text-slate-500">
              ...
              <div className="p-4">
                ...
                <div className="text-xs text-slate-500">{getFacebookUrl()}</div>
              </div>
            </div>
          </div>
        </CardContent>
      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex items-center space-x-2 mb-4">
            ...
            <h3 className="text-lg font-semibold text-slate-900">Twitter Preview</h3>
          </div>
          ...
          <div className="bg-slate-50 p-4 rounded-lg">
            <div className="border border-slate-200 rounded-2xl overflow-hidden bg-white">
              ...
              <div className="p-4">
                ...
                <div className="text-xs text-slate-500">{getTwitterUrl()}</div>
              </div>
            </div>
          </div>
        </CardContent>
