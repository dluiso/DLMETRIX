  ...
  return (
    <div className={cn("absolute inset-0 overflow-hidden pointer-events-none", className)}>
      ...
      <div className="absolute inset-0 opacity-8 dark:opacity-6">
        ...
        <div className="absolute inset-0 bg-gray-100 dark:bg-gray-800 opacity-15 pointer-events-none"></div>
        ...
        <div className="absolute animate-progress-line-full" style={{ 
          ...
          width: '4px', 
          height: '75%', 
          background: 'linear-gradient(to top, rgba(220, 38, 38, 0.15), rgba(234, 88, 12, 0.15), rgba(202, 138, 4, 0.15), rgba(37, 99, 235, 0.15), rgba(22, 163, 74, 0.15))',
        ...
        <div className="absolute animate-progress-line-30" style={{ 
          ...
          width: '2.5px', 
          height: '30%', 
          background: 'linear-gradient(to top, rgba(220, 38, 38, 0.15), rgba(234, 88, 12, 0.15), rgba(202, 138, 4, 0.15))',
          transformOrigin: 'bottom',
          animationDelay: '0.8s',
          animationDuration: '6s'
        }}>
          {/* Counter for 30% */}
          <div className="absolute" style={{ left: '5px', top: '0px' }}>
        ...
        <div className="absolute animate-progress-line-45" style={{ 
          ...
          width: '1.5px', 
          height: '45%', 
          background: 'linear-gradient(to top, rgba(220, 38, 38, 0.15), rgba(234, 88, 12, 0.15), rgba(202, 138, 4, 0.15), rgba(37, 99, 235, 0.15))',
          transformOrigin: 'bottom',
          animationDelay: '1.5s',
          animationDuration: '7s'
        }}>
          {/* Counter for 45% */}
          <div className="absolute" style={{ left: '4px', top: '0px' }}>
